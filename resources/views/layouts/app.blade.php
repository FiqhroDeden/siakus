...
<head>
    ...
    <meta charset="utf-8" />
    @if (Route::current()->getName() == 'dashboard' || Route::current()->getName() == 'dashboard.tahun')
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
        ...
        <div class="main-content">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © DenDev.
                        </div>
                        <div class="col-sm-6">
    ...
    {{-- <script src="{{ asset('assets') }}//js/pages/dashboard-crm.init.js"></script> --}}
     <!--jquery cdn-->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha1000006-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
    {{-- DataTables --}}
    ...
    <!--select2 cdn-->
    <script src="{{ asset('assets') }}//js/pages/select2.full.min.js"></script>
            ...
            revenueExpensesChartsColors &&
                ((options = {
                    series: [
                        ...
                        {
                            name: "Pemasukan",
                            data: [@json($data['pemasukan_januari']), @json($data['pemasukan_februari']), @json($data['pemasukan_maret']), @json($data['pemasukan_april']), @json($data['pemasukan_mei']), @json($data['pemasukan_juni']), @json($data['pemasukan_juli']), @json($data['pemasukan_agustus']), @json($data['pemasukan_september']), @json($data['pemasukan_oktober']), @json($data['pemasukan_november']), @json($data['pemasukan_desember'])].map(function(x) {
                                return x.toLocaleString('id-ID')
                            }),
                        },
                        {
                            name: "Pengeluaran",
                            data: [@json($data['pengeluaran_januari']), @json($data['pengeluaran_februari']), @json($data['pengeluaran_maret']), @json($data['pengeluaran_april']), @json($data['pengeluaran_mei']), @json($data['pengeluaran_juni']), @json($data['pengeluaran_juli']), @json($data['pengeluaran_agustus']), @json($data['pengeluaran_september']), @json($data['pengeluaran_oktober']), @json($data['pengeluaran_november']), @json($data['pengeluaran_desember'])].map(function(x) {
                                return x.toLocaleString('id-ID')
                            }),
                        },
                    ],
