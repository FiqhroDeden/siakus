                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        ...
                                                        <?php $p_3 = $pemasukan->where('id_neraca', 3)->sum('jumlah_masuk') - $pengeluaran
                                                        ->where('id_rekening', 3)->sum('jumlah_pengeluaran') - $pindah_buku->where('from', 3)
                                                        ->sum('jumlah') + $pindah_buku->where('to', 3)->sum('jumlah') ?>

                                                        @if($pemasukan->where('id_neraca', 3)->sum('jumlah_masuk') - $pengeluaran
                                                        ->where('id_rekening', 3)->sum('jumlah_pengeluaran') - $pindah_buku->where('from', 3)
                                                        ->sum('jumlah') + $pindah_buku->where('to', 3)->sum('jumlah') == 0)
                                                        -
                                                        @else
                                                            
                                                            {{ number_format($pemasukan->where('id_neraca', 3)->sum('jumlah_masuk') - $pengeluaran
                                                            ->where('id_rekening', 3)->sum('jumlah_pengeluaran') - $pindah_buku->where('from', 3)
                                                            ->sum('jumlah') + $pindah_buku->where('to', 3)->sum('jumlah'),2,',','.') }}
                                                        @endif  
                                                    </td>
                                                </tr>
                                                <tr>
