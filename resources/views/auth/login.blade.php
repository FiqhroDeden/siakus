...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Login | SIAKUS</title>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="" class="d-inline-block auth-logo">
                                    <h3 style="color:white">Sistem Informasi Keuangan Sekolah</h3>
                                </a>
                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Silahkan Login Dibawah ini.</p>
                                </div>
                                <div class="p-2 mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> DenDev. Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand
                            </p>
                        </div>
                    </div>
                </div>
